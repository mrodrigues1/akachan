 ...
 */
suspend fun persistMilestonePhoto(context: Context, source: Uri, milestone: Milestone): Uri? =
    withContext(Dispatchers.IO) {
        runCatching {
            ...
            // overwrites the file the saved achievement still points at — canceling the
            ...
            val target = File(dir, "${milestone.name}_${System.currentTimeMillis()}.jpg")
            ...
            val temp = File.createTempFile("${milestone.name}_", ".tmp", dir)
